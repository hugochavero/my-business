    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('cash', 'Efectivo'), ('bank', 'Banco')], default='Efectivo', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_accounts', models.ManyToManyField(related_name='%(app_label)s_%(class)s_source_account', to='core.account')),
                ('target_accounts', models.ManyToManyField(related_name='%(app_label)s_%(class)s_target_account', to='core.account')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('qty', models.PositiveIntegerField()),
                ('operation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.buyoperation')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.product')),
            ],
            options={
                'abstract': False,
